    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-10"
      ...
      <div className="relative w-full max-w-md sm:max-w-[420px] max-h-[90vh] sm:max-h-[80vh] rounded-sa-lg"
        ...
        <div className="rounded-sa-lg">
          <div className="relative z-20 p-4 sm:py-10 sm:px-8">
            ...
            <div className="text-center mb-3 sm:mb-6">
              ...
              <div className="flex justify-center mt-3 sm:mt-5 mb-1.5 sm:mb-3">
            ...
            <div className="h-px mb-3 sm:mb-5" style={{ background: `linear-gradient(90deg, transparent, ${config.border}, transparent)` }} />
            ...
            <div className="grid grid-cols-2 gap-1.5 sm:gap-2 mb-3 sm:mb-6">
              {[
            ...
            <div className="text-center">
              <div className="h-px mb-2.5 sm:mb-4" style={{ background: `linear-gradient(90deg, transparent, ${config.border}, transparent)` }} />
