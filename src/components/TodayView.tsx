  ...
  return (
    <div ref={containerRef} className="relative mb-14 text-center animate-rise py-10 px-8">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        clipPath: `polygon(
          33.2px -2px, calc(100% - 33.2px) -2px,
          calc(100% - 33.2px) -2px, calc(100% + 2px) 33.2px,
          calc(100% + 2px) 33.2px, calc(100% + 2px) calc(100% - 33.2px),
          calc(100% + 2px) calc(100% - 33.2px), calc(100% - 33.2px) calc(100% + 2px),
          calc(100% - 33.2px) calc(100% + 2px), 33.2px calc(100% + 2px),
          33.2px calc(100% + 2px), -2px calc(100% - 33.2px),
          -2px calc(100% - 33.2px), -2px 33.2px,
          -2px 33.2px, 33.2px -2px
        )`
      }}>
